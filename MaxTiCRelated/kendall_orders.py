...
if len(parameters) < 2:
  print ("usage: python kendall.py species_tree_file orders_file")
  exit()
...
for p in parameters[2:]:
  ...
  if words[0] == "t":
    ...
    print("unused parameter (bad format):")
...
with open(parameters[1]) as f:
    for line in f:
        order_input = line.strip().split(",")
	print(similarity(order_tree ,order_input))
