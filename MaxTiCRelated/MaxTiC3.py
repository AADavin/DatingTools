...
if len(parameters) < 2:
    print
    "usage: python MaxTiC.py species_tree_file constraints_file [ls=LOCAL_SEARCH] [t=TEMPERATURE] [r=RANDOMIZATION_TYPE] [d=MIN_DISTANCE] [rd=RANDOM_TREES] [ts=THRESHOLD_CONSTRAINTS]"
    exit()
