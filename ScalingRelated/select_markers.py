...
def return_closest_marker(n, n2marker):
    for i in range(2000):
...
def select_markers(refpath, gtreepath):
    ...
    for marker, leaves in gt2leaves.items():   
        ...
        if len(leaves) in n2marker and len(n2marker[len(leaves)]) >= 1:      
            ...
            cm = return_closest_marker(len(leaves),n2marker)
            if cm == None:
                pass
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print ("usage: python select_markers.py /Users/davin/Desktop/GitHub/Private/VirusScaling/Data/genetrees /Users/davin/Desktop/GitHub/Private/VirusScaling/ZombiRuns/Experiment2/G/Gene_trees/")
        exit(0)
