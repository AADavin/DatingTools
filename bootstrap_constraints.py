...
def bootstrap_constraints(transfers_file, tree_file, replicates):
    ...
    for i in range(replicates):
        with open("./TR_Replicate_NUM.tsv".replace("TR",transfers_file).replace("NUM",str(i)), "w") as f:
...
if __name__ == "__main__":
    ...
    bootstrap_constraints(transfers_file, tree_file, int(replicates))
